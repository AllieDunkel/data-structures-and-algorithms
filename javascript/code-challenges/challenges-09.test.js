...
E.g. [4,2,7,5,9,2] -> 9
------------------------------------------------------------------------------------------------ */
const maxInArray = (arr) => arr.reduce((previous, current) => current > previous ? current : previous);
...
const getCourseKeys = (obj) => {
  let onlyKeys = Object.keys(courseInfo);
...
const getHouses = (arr) => arr.map(characters => characters.house);
/*------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const hasChildrenValues = (arr, character) => {
  let haschildren = arr.filter((value) => Object.values(value).includes(character));
  if(haschildren[0].children !== undefined) {
  return true;
  }
};
