...
const addValues = (arr) => arr.reduce ((prevValue, currValue) => prevValue + currValue, 0);
...
const addPurchases = (arr) => arr.reduce ((prevValue,currValue) => prevValue + currValue.purchasePrice, 0);
...
const countNumberOfElements = (arr) => arr.reduce((prevValue) => prevValue + 1,0);
...
const reversedString = (str) => str.split('').reduce((prevValue, currValue) => currValue + prevValue, '');
